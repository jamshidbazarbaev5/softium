...
export default function Services() {
    ...
    const servicesData = services?.service ? (Array.isArray(services.service) ? services.service : []) : [];
                ...
                <div className="container">
                    ...
                    <div className="services-block">
                        ...
                        <div className="services-block-inner" data-aos="fade-up">
                            ...
                            <div className="services-block-inner-text" data-aos="fade-up">
                                <p>Softium разрабатывает эффективные маркетинговые стратегии для продвижения вашего бренда и привлечения клиентов через цифровые каналы.</p>
                            </div>
                        </div>
                    </div>
