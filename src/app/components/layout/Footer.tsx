          ...
          <div className="footer-block">
                ...
                <li data-aos="fade-up" data-aos-duration="800">
                  <a href="#">
                    <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M33.2118 16.9125C33.2118 7.83764 25.8467 0.472595 16.7719 0.472595C7.69712 0.472595 0.332031 7.83764 0.332031 16.9125C0.332031 24.8694 5.98735 31.4947 13.4839 33.0236V21.8444H10.196V16.9125H13.4839V12.8025C13.4839 9.62964 16.065 7.04852 19.2379 7.04852H23.3479V11.9805H20.0599C19.1557 11.9805 18.4159 12.7203 18.4159 13.6245V16.9125H23.3479V21.8444H18.4159V33.2702C26.7181 32.4481 33.2118 25.4448 33.2118 16.9125Z" fill="white" />
                    </svg>
                  </a>
                </li>
            ...
            <div className="footer-block-links">
              <ul className="footer-block-links-list">
                <li data-aos="fade-up" data-aos-duration="600"><Link href="#">О НАС</Link></li>
                <li data-aos="fade-up" data-aos-duration="650"><Link href="#">УСЛУГИ</Link></li>
                <li data-aos="fade-up" data-aos-duration="700"><Link href="#">ПОРТФОЛИО</Link></li>
                <li data-aos="fade-up" data-aos-duration="750"><Link href="#">ОБРАТНОЙ СВЯЗЬ</Link></li>
                <li data-aos="fade-up" data-aos-duration="800"><Link href="#">НАШИ КЛИЕНТЫ</Link></li>
              </ul>
              <ul className="footer-block-links-list">
                <li data-aos="fade-up" data-aos-duration="600"><Link href="#">UX/UI DESIGN</Link></li>
                <li data-aos="fade-up" data-aos-duration="650"><Link href="#">РАЗРАБОТКА САЙТОВ</Link></li>
                <li data-aos="fade-up" data-aos-duration="700"><Link href="#">РАЗРАБОТКА ПРИЛОЖЕНИЙ</Link></li>
                <li data-aos="fade-up" data-aos-duration="750"><Link href="#">МАРКЕТИНГ</Link></li>
              </ul>
              <ul className="footer-block-links-list">
                <li data-aos="fade-up" data-aos-duration="600"><Link href="#">info@softium.com</Link></li>
                <li data-aos="fade-up" data-aos-duration="650"><Link href="#">+998 99 999 99 99</Link></li>
                <li data-aos="fade-up" data-aos-duration="700"><Link href="#">+998 99 999 99 99</Link></li>
              </ul>
            </div>
          </div>
        </div>
